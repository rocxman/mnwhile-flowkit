            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="mt-12 flex items-center gap-6 text-sm text-brand-secondary">
                        <a href="https://docs.openflowkit.com" className="hover:text-brand-primary transition-colors">Documentation</a>
                        ...
                        <span className="opacity-30">•</span>
                        <a href="https://docs.openflowkit.com/roadmap" className="hover:text-brand-primary transition-colors">Roadmap</a>
                    </div>
