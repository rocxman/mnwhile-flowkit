# Contributing to MNWHILE FlowKit
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/Vrun-design/MNWHILE FlowKit/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.
...
This section guides you through submitting an enhancement suggestion for MNWHILE FlowKit, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.
...
- **Component size**: aim for ≤ 250 lines per component. Larger components should be split (see `docs/architecture/ARCHITECTURE.md` for how `CustomNode` was decomposed).
...
See [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) for a full breakdown of the store slices, hook hierarchy, node system, DSL, and export pipeline.
