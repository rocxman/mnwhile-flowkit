...
export const STARTER_TEMPLATE_MANIFESTS: TemplateManifest[] = [
  ...
  createTemplate(
    ...
    [
      createAssetNode('aws-saas-1', 'aws', 'API Gateway', 'App Integration', 'app-integration-api-gateway', -220, 0),
      createAssetNode('aws-saas-2', 'aws', 'Lambda API', 'Compute', 'compute-lambda', 0, 0),
      createAssetNode('aws-saas-3', 'aws', 'EventBridge', 'App Integration', 'app-integration-eventbridge', 220, 0),
      createAssetNode('aws-saas-4', 'aws', 'SQS Work Queue', 'App Integration', 'app-integration-simple-queue-service', 220, 240),
      createAssetNode('aws-saas-5', 'aws', 'Step Functions', 'App Integration', 'app-integration-step-functions', 460, 240),
      createAssetNode('aws-saas-6', 'aws', 'DynamoDB Tenant Data', 'Database', 'database-dynamodb', 0, 240),
      ...
      createAssetNode('aws-saas-8', 'aws', 'CloudWatch Alerts', 'Management Governance', 'management-governance-cloudwatch', -220, 480),
  ...
  createTemplate(
    ...
    [
      ...
      createAssetNode('aws-cont-6', 'aws', 'ElastiCache', 'Database', 'database-elasticache', 460, 240),
